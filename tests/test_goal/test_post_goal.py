...
@pytest.mark.django_db
def test_create_forbidden_to_user_wo_rights(client, logged_in_user, category_for_user2):
    data = {"title": GOAL_NAME, "category": category_for_user2.id, "due_date": DUE_DATE}
...
def test_create_forbidden_to_reader(
    ...
    data = {
        "title": GOAL_NAME,
        "category": category_for_board_user2_user1_reader.id,
        "due_date": DUE_DATE,
    }
